...
Runner.class: DFA.java DFAWalker.java FiniteAutomata.java NFA.java NFAConverter.java NFASimulator.java NFATools.java RecursiveDescentParser.java Runner.java SpecificationReader.java
	javac *.java
